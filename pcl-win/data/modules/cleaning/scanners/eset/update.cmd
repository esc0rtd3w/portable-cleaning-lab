...
set appName=ESET NOD32 Antivirus
set appBin=ecls.exe
set appVersion=8.0.304.0
:: Next Line Only Needed If All Users Folder Is Used
set pathUpdatesLocalNameAU=ESET
...
set msiExtractPathTemp=[ProductName]

:: Default Update Settings for use with WGET
set remoteFile=http://download.eset.com/download/win/eav/eav_nt32_enu.msi
...
%mkdir% "%adl%\ESET\Updfiles\"
%copy% "%pathCoreLocalRun%\extracted\%msiExtractPathTemp%\APPDATADIR\Updfiles\*" "%adl%\ESET\ESET NOD32 Antivirus\updfiles"
::----------------------------------------------------------------------------
