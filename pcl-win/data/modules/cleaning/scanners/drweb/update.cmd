...
set appName=Dr Web - CureIt
::set appBin=drwebwcl.exe
set appBin=scanner.exe
set appVersion=5.0.2.03300
...
::set pathUpdatesLocalNameUsers=Doctor Web
...
:: OLD GUI LINKS
::set remoteFile=http://www.freedrweb.com/download+cureit/gr/?lng=en
::set localFile=scanner.exe
set remoteFile=https://www.freedrweb.com/download+cureit/gr/?lng=en
set localFile=scanner.exe
::set remoteFile64=http://www.website.com/file64.zip
::set localFile64=file64.zip

:: Registration Trial Links:
:: https://download.drweb.com/demoreq/step2/?t=144a183bda2a34214c386b450ba0ff83&lng=en
:: Trial Key:
:: T2XQ-7G67-38TT-3S9A

:: Default Scanner/Definition Links for use with WGET
::set remoteFileScanner=http://www.freedrweb.com/download+cureit/gr/?lng=en
...
%wget% --no-check-certificate -O "%pathCoreLocalRun%\%localFile%" "%remoteFile%"
::%wget% -O "%pathCoreLocalRun%\%localFile%" "%remoteFile%"
::%wget% -O "%pathCoreLocalRun%\%localFile64%" "%remoteFile64%"
::%wget% -O "%pathCoreLocalRun%\%localFileScanner%" "%remoteFileScanner%"
::%wget% -O "%pathCoreLocalRun%\%localFileDefinitions%" "%remoteFileDefinitions%"
...
%copy% "%pathCoreLocalRun%\%localFile%" "%pathCoreLocalRun%\core"
::----------------------------------------------------------------------------
...
::if defined blobUsers %pclCompressBlob% %blobUsers% "%pathUpdatesLocalUsers%\%moduleActive%"
