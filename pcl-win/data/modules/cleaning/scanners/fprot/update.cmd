...
set appName=F-PROT Antivirus for Windows
set appBin=fpscan.exe
set appVersion=6.7.5.5955
:: Next Line Only Needed If All Users Folder Is Used
set pathUpdatesLocalNameAU=FRISK Software
...
set msiExtractPathTemp=Program Files\FRISK Software\F-PROT Antivirus for Windows

:: Default Update Settings for use with WGET
set remoteFile=http://files.f-prot.com/files/windows/fpav-windows-x86-hc-en.msi
set localFile=scanner.msi
...
%mkdir% "%au%\FRISK Software\F-PROT Antivirus for Windows"
%copy% "%pathCoreLocalRun%\extracted\Application Data\FRISK Software\F-PROT Antivirus for Windows\config.xml" "%au%\FRISK Software\F-PROT Antivirus for Windows"
%copy% "%pathCoreLocalRun%\extracted\Application Data\FRISK Software\F-PROT Antivirus for Windows\config.xml.csum" "%au%\FRISK Software\F-PROT Antivirus for Windows"
%copy% "%pathCoreLocalRun%\extracted\Application Data\FRISK Software\F-PROT Antivirus for Windows\antivir\antivir.def" "%au%\FRISK Software\F-PROT Antivirus for Windows"
if exist "%au%\FRISK Software\F-PROT Antivirus for Windows\antivir" %rmdir% "%au%\FRISK Software\F-PROT Antivirus for Windows\antivir"
::----------------------------------------------------------------------------
