...
set appName=SuperAntiSpyware
set appBin=SUPERAntiSpyware.exe
set appVersion=6.0.1206
:: Next Line Only Needed If All Users Folder Is Used
set pathUpdatesLocalNameAU=SUPERAntiSpyware.com
:: Next Line Only Needed If Current User Folder Is Used
set pathUpdatesLocalNameCU=SUPERAntiSpyware.com
...
:: Used if only there are 2 separate x86 and x64 layouts
set bitSplit=1
::----------------------------------------------------------------------------------
...
:: SAS Log Clean before blob repack
%rm% "%pathUpdatesLocalAU%\SUPERAntiSpyware\AppLogs\*"
...
:: SuperAntiSpyware Specific
%rm% "%SystemDrive%\SuperDELETE"
