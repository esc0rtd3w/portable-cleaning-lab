...
set appName=VBA32 Antivirus
set appBin=vbaupdx.exe
set appVersion=3.12.26.0
...
set remoteFile=ftp://anti-virus.by/pub/vba32w-latest.rar
set localFile=scanner.rar
...
::set remoteFileScanner=ftp://anti-virus.by/pub/vba32w-latest.rar
::set localFileScanner=scanner.rar
::set remoteFileScanner=ftp://anti-virus.by/pub/vba32w-latest.zip
...
::set binArgs=
set binUpdate="%pathCoreLocalRun%\core\%appBin%" http://www.anti-virus.by/update/
...
:: If defCheckFileTemp does not exist and we landed here, we must assume defCheckFileComplete also does not exists
:chkVerify
