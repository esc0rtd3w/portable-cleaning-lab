...
echo.
echo.
echo Preparing Definition Files....
echo.
echo.

:: Copy bases.cav DEFINITIONS before scanning
%copy% "%pathCoreLocalRun%\core\bases.cav" "%pathCoreLocalRun%\core\%bits%\scanners\bases.cav"
