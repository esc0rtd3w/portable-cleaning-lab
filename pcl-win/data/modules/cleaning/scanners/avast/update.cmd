...
set scriptVersion=v2.7

::----------------------------------------------------------------------------------
:: THESE ARE THE ONLY VARIABLES NEEDED FOR GLOBAL COMPATIBILITY
set appName=Avast Antivirus
set appBin=aswMBR.exe
set appVersion=1.0.1.2290
...
set pathUpdatesLocalNameTempCU=_av4_
...
set remoteFileScanner=http://files.avast.com/files/rootkit-scanner/aswmbr.exe
set localFileScanner=aswmbr.exe
set remoteFileDefinitions=http://files.avast.com/files/latest/400.vps
set localFileDefinitions=400.vps
::----------------------------------------------------------------------------------
...
:: User Agents
:: Default User Agent
set userAgent=--user-agent="aswMBR"
...
set defCheckFile="%temp%\_av4_\data\400.vps"
set defCheckFileComplete="%temp%\_av4_\data\updldr0.bin"
set defCheckFileTemp="%temp%\_av4_\data\400.tmp"
