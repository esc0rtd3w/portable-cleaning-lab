...
set appName=Spybot Search and Destroy
set appBin=SDUpdate.exe
set appVersion=2.4.40
:: Next Line Only Needed If All Users Folder Is Used
::set pathUpdatesLocalNameAU=Spybot - Search & Destroy
...
::set binArgs=
set binUpdate="%pathCoreLocalRun%\core\%appBin%"
set binUpdateSilent="%pathCoreLocalRun%\core\%appBin%"
...
%regExportToFile% "HKLM\SOFTWARE\Safer Networking Limited" %regFileAddHKLM% -y
%regExportToFile% "HKCU\SOFTWARE\Safer Networking Limited" %regFileAddHKCU% -y
...
:: Remove AllUsers with Ampersand!!!
if exist "%au%\Spybot - Search & Destroy" %rmdir% "%au%\Spybot - Search & Destroy"
