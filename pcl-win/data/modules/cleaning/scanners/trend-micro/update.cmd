...
set appName=Trend Micro SysClean
set appBin=sysclean.com
set appVersion=1.2.1003
...
set remoteFileScanner=http://files.trendmicro.com/products/tsc/sysclean.zip
set localFileScanner=scanner.zip
set remoteFileDefinitions=http://www.trendmicro.com/ftp/products/aupattern/consumer/cvsapi403.zip
...
set counterURL=http://www.trendmicro.com/ftp/products/aupattern/consumer/cvsapi

set /p counterVer=<"%pathCoreLocalRun%\core\defnum.txt"
::set counterVer=793
...
::----------------------------------------------------------------------------
:: Parse HTML
::set baseURL="http://downloadcenter.trendmicro.com/index.php?clk=tab_pattern&clkval=33&regs=NABU&lang_loc=1"
::set baseName=

::%wget% %userAgent% -F -O "%pathCoreLocalRun%\pclParse.html" "%baseURL%"
::pause
::setlocal ENABLEDELAYEDEXPANSION
...
if defined blobTempAU %pclCompressBlob% %blobTempAU% "%pathUpdatesLocalTempAU%"
if defined blobTempCU %pclCompressBlob% %blobTempCU% "%pathUpdatesLocalTempCU%"
