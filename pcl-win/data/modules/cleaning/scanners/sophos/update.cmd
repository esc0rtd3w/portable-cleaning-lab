...
set appName=Sophos Virus Removal Tool
set appBin=SVRTcli.exe
set appVersion=2.80.0.0
:: Next Line Only Needed If All Users Folder Is Used
set pathUpdatesLocalNameAU=Sophos
...
set msiExtractPathTemp=program files\Sophos\Sophos Virus Removal Tool

:: Default Update Settings for use with WGET
set remoteFile=http://downloads.sophos.com/tools/withides/Sophos Virus Removal Tool.exe
set localFile=sav32sfx.exe
...
%rar% x -y "%pathCoreLocalRun%\sav32sfx.exe" "%pathCoreLocalRun%\temp"
::----------------------------------------------------------------------------
::----------------------------------------------------------------------------
:: Compress File RAR
...
msiexec /a "%pathCoreLocalRun%\temp\Sophos Virus Removal Tool.msi" /qb TARGETDIR="%pathCoreLocalRun%\extracted"
::----------------------------------------------------------------------------
...
:: Triggering scanner exe to finish updates
:: This works but must close manually after UPDATE SUCCESS
::%binScanner% %binArgs%
