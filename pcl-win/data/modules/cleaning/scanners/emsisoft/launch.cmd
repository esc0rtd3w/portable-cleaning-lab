...
set appName=Emsisoft Antivirus
set appBin=a2cmd.exe
set appVersion=9.0.0.4523
...
set binArgs=/deep /rootkits /memory /traces /cookies /q
set binUpdate="%pathCoreLocalRun%\core\bin\%appBin%" /update
set binUpdateSilent="%pathCoreLocalRun%\core\bin\%appBin%" /update -silent
