...
set scriptVersion=v2.5

::----------------------------------------------------------------------------------
:: THESE ARE THE ONLY VARIABLES NEEDED FOR GLOBAL COMPATIBILITY
set appName=Panda Antivirus
set appBin=Pavcl.exe
set appVersion=9.5.1.2
:: Next Line Only Needed If All Users Folder Is Used
set pathUpdatesLocalNameAU=Panda Security
...
set remoteFileScanner=http://research.pandasecurity.com/blogs/images/pavcl.zip
set localFileScanner=scanner.zip
::set remoteFileDefinitions=http://acs.pandasoftware.com/marketing/promo/AP14.exe
::set localFileDefinitions=definitions.exe
set remoteFileDefinitions=http://5487HGVFFS:87TRGFVF@acs.pandasoftware.com/member/pavsig3/pav.zip
