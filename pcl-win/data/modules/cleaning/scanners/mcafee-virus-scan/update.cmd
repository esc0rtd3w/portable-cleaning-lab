...
set appName=McAfee Virus Scan
set appBin=scan.exe
set appVersion=6.0.4.564
...
:: Set Scanner variable link base, left side, right side, and version number
set scannerLinkBasePath=http://b2b-download.mcafee.com/products/evaluation/vcl/w32
set scannerLinkBaseFileNameLeft=vscl-w32-
set scannerLinkBaseFileNameRight=-e.zip
set scannerLinkVersion=604

:: Set Scanner combined name and temp path
set scannerUpdateTempName=%scannerLinkBaseFileNameLeft%%scannerLinkVersion%%scannerLinkBaseFileNameRight%

:: Set remote scanner file (matches defaults)
set remoteFileScanner=%scannerLinkBasePath%/%scannerUpdateTempName%

:: Set variables for definitions
set baseURL=ftp://ftp.mcafee.com/commonupdater
set baseName=avvdat-

:: Direct Link for reference
:: ftp://ftp.mcafee.com/commonupdater/avvdat-7602.zip

:: Download file to parse from webpage
set pageToParse=ftp://ftp.mcafee.com/commonupdater/
...
set newLink=%newLinkTemp2:~0,0%
set newVer=%newLinkTemp1:~-16,-12%
...
%unpack7z% "%pathCoreLocalRun%\%localFileScanner%" -o"%pathCoreLocalRun%\core"
%unpack7z% "%pathCoreLocalRun%\%localFileDefinitions%" -o"%pathCoreLocalRun%\core"
::----------------------------------------------------------------------------
