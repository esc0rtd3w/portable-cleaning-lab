...
::----------------------------------------------------------------------------------
:: PORTABLE CLEANING LAB MODULE FRAMEWORK TEMPLATE (LAUNCH SCANNER MENU)
...
set scantype=99
cls
echo Select a scan type and press ENTER:
echo.
echo.
echo 1) All Local Drives, MBR, and Inside of Archives
echo.
echo 2) All Local Drives, MBR, and Skip Searching Archives
echo.
echo 3) Select Custom Path and Options
echo.
echo.

set /p scantype=

if %scantype% gtr 3 goto menu

if %scantype%==1 goto opt1

if %scantype%==2 goto opt2

if %scantype%==3 goto opt3
...
echo.
echo.
echo Launching Scanner [%version%]...

cls

"%runDirectory%\data\%appBin%" ARGUMENTS

echo.
echo.
echo.
echo.
echo Please take a moment to view the results.
echo.
echo.
