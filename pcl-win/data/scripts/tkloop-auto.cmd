...
title Known Baddie Executable Kill From Memory Loop
...
set list=%~dp0lists\processList.txt

set kill=taskkill /f /im
set killtree=taskkill /f /t /im


%killtree% rundll32.exe
%killtree% rundll32.exe
%killtree% rundll32.exe
%kill% rundll32.exe
%kill% rundll32.exe
